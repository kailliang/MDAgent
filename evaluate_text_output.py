...
output_filename = 'evaluation/medqa_adaptive_332_light.csv'
...
for sample in data:
    ...
    if isinstance(resp, dict):
        # Handle new basic mode format with direct 'answer' key
        if 'answer' in resp:
            response = resp['answer']  # Direct extraction for basic mode
